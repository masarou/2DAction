...
public:
	...
	enum BUTTON_KIND{
		...
		BUTTON_DECIDE	= PAD_INPUT_3,
		BUTTON_CANCEL	= PAD_INPUT_1,
		BUTTON_SPECIAL1	= PAD_INPUT_4,
		BUTTON_SPECIAL2	= PAD_INPUT_2,
		BUTTON_R1		= PAD_INPUT_6,
		BUTTON_L1		= PAD_INPUT_5,
		BUTTON_R2		= PAD_INPUT_8,
		BUTTON_L2		= PAD_INPUT_7,
		BUTTON_START	= PAD_INPUT_12,
		BUTTON_SELECT	= PAD_INPUT_11,
